print('Задача 10. Поменять местами: не всё так просто! (необязательная, '
...
# но без использования третьей переменной и без использования  синтаксического
# сахара,
...
# Изменять, удалять, менять местами 10, 11 строку, первый и второй print
# нельзя.
# Но между 12-й и 14-й строчкой можно вставлять сколько угодно строк кода, не
# трогая последний принт.
